...
public interface ShiwuzhaolingService extends IService<ShiwuzhaolingEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<ShiwuzhaolingEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<ShiwuzhaolingEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<ShiwuzhaolingEntity> wrapper);
