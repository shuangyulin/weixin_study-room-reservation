<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"0px 0 0 177px","margin":"111px 0 ","position":"relative","background":"#E7E7E7","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"20px 40px","margin":"-10px  0  0 80px","borderColor":"#3b6885","borderWidth":"0 0 0px 0","background":"#fff","width":"calc(100% - 40px)","fontSize":"16px","position":"fixed","borderStyle":"solid","zIndex":"22"}' class="bread-crumbs"></bread-crumbs>
